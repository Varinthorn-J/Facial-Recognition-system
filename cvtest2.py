...
firebase = firebase.FirebaseApplication('https://fir-real-time-database-96756-default-rtdb.firebaseio.com/fir-real-time-database-96756-default-rtdb', None)
result = firebase.get('/person/', '')
for person in result:
    jsn = requests.get('https://fir-real-time-database-96756-default-rtdb.firebaseio.com/fir-real-time-database-96756-default-rtdb/person.json')
    data = jsn.json()
    ...
    person_face_names.append(data[person]['Image'])
